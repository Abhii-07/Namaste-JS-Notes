...
```js
const users = [
	{ firstName: "Abhijeet ", lastName: "Hiwale", age: 23 },
	{ firstName: "Ashish", lastName: "Kumar", age: 29 },
	{ firstName: "Ankit", lastName: "Roy", age: 29 },
	{ firstName: "Pranav", lastName: "Mukherjee", age: 50 },
];
// Get array of full name : ["Abhijeet Hiwale", "Ashish Kumar", ...]
const fullNameArr = users.map((user) => user.firstName + " " + user.lastName);
console.log(fullNameArr); // ["Abhijeet Hiwale", "Ashish Kumar", ...]
...
console.log(output); // ["Abhijeet ", "Ashish", "Ankit"]
